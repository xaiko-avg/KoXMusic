...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("DXINFO143")
                await self.one.join_chat("DX_INFO")
                await self.one.join_chat("DX_LOGS")
                await self.one.join_chat("DP_CUTE_BOYS_GIRLS")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("DXINFO143")
                await self.two.join_chat("DX_INFO")
                await self.two.join_chat("DX_LOGS")
                await self.two.join_chat("DP_CUTE_BOYS_GIRLS")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("DXINFO143")
                await self.three.join_chat("DX_INFO")
                await self.three.join_chat("DX_LOGS")
                await self.three.join_chat("DP_CUTE_BOYS_GIRLS")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("DXINFO143")
                await self.four.join_chat("DX_INFO")
                await self.four.join_chat("DX_LOGS")
                await self.four.join_chat("DP_CUTE_BOYS_GIRLS")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("DXINFO143")
                await self.five.join_chat("DX_INFO")
                await self.five.join_chat("DX_LOGS")
            except:
                pass
            assistants.append(5)
